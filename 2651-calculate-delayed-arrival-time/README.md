...
<pre style="position: relative;"><strong>Input:</strong> arrivalTime = 15, delayedTime = 5 
...
<pre style="position: relative;"><strong>Input:</strong> arrivalTime = 13, delayedTime = 11
